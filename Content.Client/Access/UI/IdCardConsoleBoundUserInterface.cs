...
namespace Content.Client.Access.UI
{
    public sealed class IdCardConsoleBoundUserInterface : BoundUserInterface
    {
        ...
        public void SubmitData(string newFullName, string newJobTitle, List<ProtoId<AccessLevelPrototype>> newAccessList, ProtoId<JobPrototype> newJobPrototype, List<ProtoId<AccessLevelPrototype>> emergencyAccessAddedList, List<ProtoId<AccessLevelPrototype>> emergencyAccessRemovedList)
        {
            ...
            SendMessage(new WriteToTargetIdMessage(
                ...
                newAccessList,
                newJobPrototype,
                emergencyAccessAddedList,
                emergencyAccessRemovedList));
        }
    }
}
