...
public sealed partial class AccessLevelControl : GridContainer
{
    ...
    public void Populate(List<ProtoId<AccessLevelPrototype>> accessLevels, IPrototypeManager prototypeManager, bool toggleMode = true, bool enableAllKeybinds = false) // Ratbite: Added flags
    {
        foreach (var access in accessLevels)
        {
            ...
            var newButton = new Button
            {
                ...
                ToggleMode = toggleMode, // ratbite
                EnableAllKeybinds = enableAllKeybinds, // ratbite
            };
            AddChild(newButton);
