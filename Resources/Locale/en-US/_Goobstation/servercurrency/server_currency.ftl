...
server-currency-name-singular = Cheese Bite
server-currency-name-plural = Cheese Bites
...
gs-balanceui-shop-buy-token-antag = Buy an Antag Token - {$price} Cheese Bites
gs-balanceui-shop-buy-token-admin-abuse = Buy an Admin Abuse Token - {$price} Cheese Bites
gs-balanceui-shop-buy-token-hat = Buy a Hat Token - {$price} Cheese Bites
