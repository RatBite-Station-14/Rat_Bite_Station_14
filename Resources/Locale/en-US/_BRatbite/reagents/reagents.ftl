...
reagent-desc-libital = A common but weak medicine used to heal brute trauma. Usually paired with other chemicals. Due to its composition, it is also very effective when applied topically as a gel.
...
reagent-desc-aiuri = A common but weak medicine used to heal burn injuries. Usually paired with other chemicals. Due to its composition, it is also very effective when applied topically as a gel.
...
reagent-desc-metorapan = An analgesic medicine derived from meralyne. It is also very effective at treating brute trauma quickly, but only in small doses. 
...
reagent-name-dermarpan = urozine
