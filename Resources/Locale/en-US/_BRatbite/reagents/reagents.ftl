...
reagent-name-aiogah = unstable space HRT solution
reagent-desc-aiogah = A concoction of hormones and chemicals that miraculously rearrange the DNA of the metaboliser, completely changing their biological sex.
...
reagent-name-urozine = urozine
reagent-desc-urozine = A powerful medicine used for treating burn damage quickly in low doses. Derived from dermaline.
